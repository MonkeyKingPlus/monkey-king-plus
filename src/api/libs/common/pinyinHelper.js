...
var HANZI_START =19968;
var HANZI_COUNT = 20902;

var firstLetterArray = new String(
...
exports.pinyinFirstLetter = function(hanzi){
    if(!hanzi){
        return hanzi;
    }
    var hanziIndex = hanzi.charCodeAt(0);
    var index = hanziIndex - HANZI_START;
    if (index >= 0 && index <= HANZI_COUNT)
    {
        return firstLetterArray[index].toUpperCase();
    }
    else
    {
        //match english name and number
        var matched = hanzi.match(/^[A-Za-z]/);
